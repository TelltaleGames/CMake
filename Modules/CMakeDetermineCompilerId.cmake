...
")
  ...
  elseif("${CMAKE_GENERATOR}" MATCHES "Visual Studio ([0-9]+)")
    ...
    if("${id_platform}" STREQUAL "x64")
      set(id_machine_10 MachineX64)
    elseif("${id_platform}" STREQUAL "Itanium")
      set(id_machine_10 MachineIA64)
      set(id_arch ia64)
    elseif("${id_platform}" STREQUAL "XBox 360")
      set(id_machine_10 "")
	...
	if("${id_platform}" STREQUAL "XBox 360")
	  set(id_runtimelib "MultiThreadedDebug")
      set(id_subsystem_10 "")
	else()
	  set(id_runtimelib "MultiThreadedDebugDLL")
      set(id_subsystem_10 "Console")
	endif()
