...
set(CMAKE_XBONE_COMPILER $ENV{XboxOneXDKLatest})
if(NOT CMAKE_XBONE_COMPILER)
    set(CMAKE_XBONE_COMPILER "$ENV{DurangoXDK}/xdk/VC/bin/x86_amd64/cl.exe")
    set (CMAKE_C_COMPILER_VERSION "17.00.65501.17025")
else()
    set(CMAKE_XBONE_COMPILER "${CMAKE_XBONE_COMPILER}/Compilers/dev11.1/VC/bin/amd64/cl.exe")
    set (CMAKE_C_COMPILER_VERSION "17.00.65501.17037")
endif()
string(REPLACE "\\" "/" CMAKE_XBONE_COMPILER "${CMAKE_XBONE_COMPILER}")
set( CMAKE_C_COMPILER "${CMAKE_XBONE_COMPILER}" )
set( CMAKE_CXX_COMPILER "${CMAKE_XBONE_COMPILER}" )
