...
if(CMAKE_SYSTEM_NAME MATCHES "WindowsCE")
  ...
  set(WINCE 1)
elseif(CMAKE_SYSTEM_NAME MATCHES "XBox360")
...
elseif(CMAKE_FORCE_X360)
  ...
  set(_PLATFORM_DEFINES "/D_XBOX ")

  set(_RTC1 "")
  set(_FLAGS_CXX " ")
  set(CMAKE_C_STANDARD_LIBRARIES_INIT "xboxkrnl.lib")

  if (MSVC_VERSION LESS 1600)
    set(CMAKE_C_STANDARD_LIBRARIES_INIT "${CMAKE_C_STANDARD_LIBRARIES_INIT} corelibc.lib")
  endif ()
elseif(CMAKE_FORCE_XBONE)
  string(TOUPPER "${MSVC_C_ARCHITECTURE_ID}" _MSVC_C_ARCHITECTURE_ID_UPPER)
  string(TOUPPER "${MSVC_CXX_ARCHITECTURE_ID}" _MSVC_CXX_ARCHITECTURE_ID_UPPER)

  set(_PLATFORM_DEFINES "/DWIN32 /D_WINDOWS; ")

  set(_RTC1 "/RTC1")
  set(_FLAGS_CXX " ")
  set(CMAKE_C_STANDARD_LIBRARIES_INIT "pixEvt.lib d3d11i.lib combase.lib kernelx.lib uuid.lib")
else()
...
if(CMAKE_FORCE_X360 OR CMAKE_FORCE_XBONE)
  set(_MACHINE_ARCH_FLAG "")
else()
...
elseif (CMAKE_COMPILER_SUPPORTS_PDBTYPE)
...
macro(__windows_compiler_msvc lang)
  ...
  if(CMAKE_FORCE_X360)
    set(CMAKE_${lang}_FLAGS_DEBUG_INIT "/D_DEBUG /Zi /Ob0 /Od ${_RTC1}")
    set(CMAKE_${lang}_FLAGS_RELEASE_INIT "/O2 /Ob2 /D NDEBUG")
    set(CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT "/Zi /O2 /Ob1 /D NDEBUG")
    set(CMAKE_${lang}_FLAGS_MINSIZEREL_INIT "/O1 /Ob1 /D NDEBUG")
  elseif(CMAKE_FORCE_XBONE)
    set(CMAKE_${lang}_FLAGS_DEBUG_INIT "/D_DEBUG /MDd /Zi /Ob0 /Od /ZW- ${_RTC1}")
    set(CMAKE_${lang}_FLAGS_RELEASE_INIT "/MD /O2 /Ob2 /ZW- /DNDEBUG")
    set(CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT "/MD /Zi /O2 /Ob1 /ZW- /DNDEBUG")
    set(CMAKE_${lang}_FLAGS_MINSIZEREL_INIT "/MD /O1 /Ob1 /ZW- /DNDEBUG")
  else()
