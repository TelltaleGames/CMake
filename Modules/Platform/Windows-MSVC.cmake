...
foreach(t EXE SHARED MODULE)
  ...
  if (CMAKE_FORCE_X360)
    string(APPEND CMAKE_EXE_LINKER_FLAGS_DEBUG_INIT " /debug /pdbtype:sept")
    string(APPEND CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO_INIT " /debug /pdbtype:sept")	
  elseif (CMAKE_FORCE_XBONE)
    string(APPEND CMAKE_EXE_LINKER_FLAGS_DEBUG_INIT " /debug ")
    string(APPEND CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO_INIT " /debug ")	
...
macro(__windows_compiler_msvc lang)
  ...
  if("x${lang}" STREQUAL "xC" OR
    ...
    if(CMAKE_VS_PLATFORM_TOOLSET MATCHES "(v[0-9]+_clang_.*|LLVM-vs[0-9]+.*)")
      ...
      if(CMAKE_FORCE_X360)
        string(APPEND CMAKE_${lang}_FLAGS_DEBUG_INIT " /Zi /Ob0 /Od ${_RTC1}")
        string(APPEND CMAKE_${lang}_FLAGS_RELEASE_INIT " /O2 /Ob2 /D NDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " /Zi /O2 /Ob1 /D NDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " /O1 /Ob1 /D NDEBUG")
      elseif(CMAKE_FORCE_XBONE)
        string(APPEND CMAKE_${lang}_FLAGS_DEBUG_INIT " /MDd /Zi /Ob0 /Od /ZW- ${_RTC1}")
        string(APPEND CMAKE_${lang}_FLAGS_RELEASE_INIT " /MD /O2 /Ob2 /ZW- /DNDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " /MD /Zi /O2 /Ob1 /ZW- /DNDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " /MD /O1 /Ob1 /ZW- /DNDEBUG")
      else()
